...
> Status dieser Doku: A-D dokumentiert, E-F noch offen
...
| E | IDOR / Broken Access Control | Offen | Noch nicht begonnen |
...
|---|---|
| E - IDOR | WebGoat `(A1) Broken Access Control` -> `IDOR.lesson` bis Aufgabe 6 bearbeiten und dokumentieren |
